            ...
            activityOrderContainer.innerHTML = `
                ...
                <ol style="margin-left: 1.5rem; margin-top: 0.5rem;">
                    <li style="margin-bottom: 0.5rem;">
                        <strong>Free Play Mode (up to 5 minutes):</strong> Create patterns however you like—no targets, just experiment freely with shapes and operations. Save your creations to a personal gallery. <em style="color: #f59e0b;">Free Play lasts up to 5 minutes. After you’ve submitted some creations to the gallery, you may be able to finish early.</em>
                    </li>
                    <li style="margin-bottom: 0.5rem;">
